...
import static io.adeprogramming.tinder_ai_backend.Utils.generateMyersBriggsTypes;
import static io.adeprogramming.tinder_ai_backend.Utils.selfieTypes;
import static org.yaml.snakeyaml.nodes.Tag.STR;

@Service
public class ProfileCreationService<ChatResponse> {
    ...
    public void createProfiles(int numberOfProfiles) {
        ...
        while (this.generatedProfiles.size() < numberOfProfiles) {
            ...
            org.springframework.ai.chat.ChatResponse response = (org.springframework.ai.chat.ChatResponse) chatClient.call(new Prompt(prompt,
    ...
    public <__TMP__> __TMP__ saveProfilesToDB() {
    }
